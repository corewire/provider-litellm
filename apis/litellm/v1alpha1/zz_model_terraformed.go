...
func (tr *Model) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"aws_access_key_id": "awsAccessKeyIdSecretRef", "aws_role_name": "awsRoleNameSecretRef", "aws_secret_access_key": "awsSecretAccessKeySecretRef", "aws_session_name": "awsSessionNameSecretRef", "model_api_key": "modelApiKeySecretRef", "vertex_credentials": "vertexCredentialsSecretRef", "vertex_location": "vertexLocationSecretRef", "vertex_project": "vertexProjectSecretRef"}
}
